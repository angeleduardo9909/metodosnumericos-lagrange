...
public class frmVentana extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("METODO LAGRANJE");

        jLabel4.setText("INTEGRANTES");

        jLabel5.setText("Miguel Angel Vazquez Pech");

        jLabel6.setText("Jonathan Aldair Ortega Canul ");

        jLabel7.setText("Angel Eduardo Casanova Herrera");
